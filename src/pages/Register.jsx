            ...
            <div className="p-7 p-lg-13 w-100 bg-light rounded">
              ...
              <form action="#">
                ...
                <div className="d-flex justify-content-center pb-7 pb-lg-12">
                  <a href="#" className="btn btn-primary text-white fs-6 fs-lg-5 fw-bold py-3 px-8 px-lg-12" role="button">註冊</a>
                </div>
                <div className="d-flex justify-content-between border-top border-black pt-5">
                  <p className="fs-8 fs-lg-7">已經有帳號？</p>
                  <a href="#" className="fs-8 fs-lg-7 text-black">立即登入<i className="bi bi-arrow-up-right ms-1"></i></a>
                </div>
              </form>
            </div>
          </div>
