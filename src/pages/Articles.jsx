                ...
                <div className="row">
                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0 px-lg-5">
                      <h5 className="card-title fs-6 fs-lg-3 fw-bold mb-0 mb-lg-7">用４步驟幫你打造更好版本的自己</h5>
      ...
      <div className="d-flex justify-content-center pt-9 pt-lg-13">
        <nav aria-label="Page navigation">
          <ul className="pagination">
            ...
            <li className="page-item"><a className="page-link fs-lg-5 ms-2" href="#">2</a></li>
            <li className="page-item"><a className="page-link fs-lg-5 ms-2" href="#">3</a></li>
          </ul>
        </nav>
      </div>
    </div>
