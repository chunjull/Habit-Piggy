            ...
            <Link to="/Article" className="card mt-7 mb-5 my-lg-11 border-0 bg-transparent">
              <div className="row">
                ...
                <div className="col-lg-7">
                    ...
                    <h5 className="card-title fs-6 fs-md-3 fw-bold mb-0 mb-lg-7">《原子習慣》幫你打造更好版本的自己</h5>
                    ...
                    <div className="d-flex justify-content-end mt-5">
                      <Link to="/Article" className="card-link link-black fs-7 fs-lg-6">觀看文章<i className="bi bi-arrow-right text-primary ps-1"></i></Link>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Link to="/Article">
              <div className="card mt-7 mb-5 my-lg-11 border-0 bg-transparent">
                <div className="row">
                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0 px-lg-5">
                      <h5 className="card-title fs-6 fs-md-3 fw-bold mb-0 mb-lg-7">培養新習慣前，先用５個步驟破除心魔</h5>
            ...
            <Link to="/Article">
              <div className="card mt-7 mb-5 my-lg-11 border-0 bg-transparent">
                <div className="row">
                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0 px-lg-5">
                      <h5 className="card-title fs-6 fs-md-3 fw-bold mb-0 mb-lg-7">三週養成習慣是迷思！做對這件事更重要</h5>
            ...
            <Link to="/Article">
              <div className="card mt-7 mb-5 my-lg-11 border-0 bg-transparent">
                <div className="row">
                  ...
                  <div className="col-lg-7">
                    <div className="card-body p-0 px-lg-5">
                      <h5 className="card-title fs-6 fs-md-3 fw-bold mb-0 mb-lg-7">養成習慣前，如何建立能夠做到的目標？</h5>
